...
// Region showing a highlight
let highlight_region = -1;
...
export function set_highlight_region(region) {
...
function pickNewRegion() {
  ...
  while (newIndex === currentRegionIndex || newIndex === highlight_region ) {
